...
(* ------------------------------- Hyperlinks ------------------------------- *)
VerificationTest[
	FaizonZaman`WLMarkdown`Lexer`Private`LinkLexer[
...
VerificationTest[
	FaizonZaman`WLMarkdown`Lexer`Private`LinkLexer[{ MarkdownToken[ <| "Token" -> "Line", "Data" -> "Here is a link <https://www.example.com>" |>] }, MarkdownRules["CommonMark"]["LinkRules"]],
...
(* ---------------------------- FootnoteReference --------------------------- *)
VerificationTest[
	FaizonZaman`WLMarkdown`Lexer`Private`LinkLexer[{ MarkdownToken[<| "Token" -> "Line", "Data" -> "There's more information about [this][1] in the footer" |>] }, MarkdownRules["CommonMark"]["LinkRules"]],
...
(* --------------------------------- Images --------------------------------- *)
VerificationTest[
	FaizonZaman`WLMarkdown`Lexer`Private`LinkLexer[{MarkdownToken[ <| "Token" -> "Line", "Data" -> "Here is ![a random image from picsum](https://picsum.photos/200)"|>]}, MarkdownRules["CommonMark"]["LinkRules"]],
