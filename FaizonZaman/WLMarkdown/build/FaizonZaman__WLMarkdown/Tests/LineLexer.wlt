...
(* -------------------------------- EmptyLine ------------------------------- *)
VerificationTest[
	FaizonZaman`WLMarkdown`Private`LineLexer["", MarkdownRules["CommonMark"]["LineRules"]],
...
VerificationTest[
	FaizonZaman`WLMarkdown`Private`LineLexer["```Mathematica", MarkdownRules["CommonMark"]["LineRules"]],
	Splice[{MarkdownToken[<| "Token" -> "CodeFence", "Data" -> "Mathematica" |>]}],
	"TestID" -> "LineLexer-CommonMark-CodeFence-Language"
]
(* ---------------------------- UnorderedListItem --------------------------- *)
VerificationTest[
	FaizonZaman`WLMarkdown`Private`LineLexer["* A level zero bullet", MarkdownRules["CommonMark"]["LineRules"]],
...
VerificationTest[
	FaizonZaman`WLMarkdown`Private`LineLexer["  * A level one bullet", MarkdownRules["CommonMark"]["LineRules"]],
...
(* ----------------------------- OrderedListItem ---------------------------- *)
VerificationTest[
	FaizonZaman`WLMarkdown`Private`LineLexer["1. A level zero bullet", MarkdownRules["CommonMark"]["LineRules"]],
...
VerificationTest[
	FaizonZaman`WLMarkdown`Private`LineLexer["  1.1 A level one bullet", MarkdownRules["CommonMark"]["LineRules"]],
...
(* ---------------------------------- Quote --------------------------------- *)
VerificationTest[
	FaizonZaman`WLMarkdown`Private`LineLexer["> Quote me!", MarkdownRules["CommonMark"]["LineRules"]],
	Splice[{MarkdownToken[<| "Token" -> "Quote", "Data" -> "Quote me!" |>]}],
	"TestID" -> "LineLexer-CommonMark-Quote"
]
(* ------------------------------- BlockQuote ------------------------------- *)
VerificationTest[
	FaizonZaman`WLMarkdown`Private`LineLexer["    Here lies your blockquote!", MarkdownRules["CommonMark"]["LineRules"]],
	Splice[{MarkdownToken[<| "Token" -> "BlockQuote", "Data" -> "Here lies your blockquote!" |>]}],
	"TestID" -> "LineLexer-CommonMark-BlockQuote"
]
(* ---------------------------------- Line ---------------------------------- *)
VerificationTest[
	FaizonZaman`WLMarkdown`Private`LineLexer["This is a line.", MarkdownRules["CommonMark"]["LineRules"]],
	Splice[{MarkdownToken[<| "Token" -> "Line", "Data" -> "This is a line." |>]}],
	"TestID" -> "LineLexer-CommonMark-Line"
]
(* -------------------------------- ListInput ------------------------------- *)
VerificationTest[
	FaizonZaman`WLMarkdown`Private`LineLexer[
